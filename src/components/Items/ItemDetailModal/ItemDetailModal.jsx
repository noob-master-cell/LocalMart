// project/src/components/Items/ItemDetailModal/ItemDetailModal.jsx
import React, { useMemo, useCallback, useEffect, memo } from "react";
// UserCircleIcon might still be needed if there's a generic contact button fallback
...
import ItemQuestions from "../ItemQuestions/ItemQuestions"; // Import the dedicated Q&A component
...
const ItemDetailModal = memo(
  ({
    ...
    const handleCopyLink = useCallback(async () => {
      ...
      // Construct the item's unique URL. Adjust path if your routing is different.
