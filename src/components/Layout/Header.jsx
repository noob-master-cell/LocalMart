// project/src/components/Layout/Header.jsx
import React, { useState, useCallback, useRef, useEffect } from "react";
import { Link, useLocation } from "react-router-dom";
import NavLinkRouter from "../Navigation/NavLinkRouter"; // Adjusted path
import HomeIcon from "../Icons/HomeIcon"; // Adjusted path
...
// import XCircleIcon from "../Icons/XCircleIcon"; // XCircleIcon is removed as per user request - path would be ../Icons/XCircleIcon
import { useDebounce } from "../../hooks/useDebounce"; // Adjusted path (assuming hooks is at src/hooks)
        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div
            className={`flex items-center transition-all duration-300 ${
              isSearchExpanded ? "ml-2 hidden sm:flex" : ""
            }`}
          >
            {user ? (
...
export default React.memo(Header); // Wrapped with React.memo as it was in original
